...
namespace AdamTaskApplication
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           services.AddDbContext<MainContext>(options => options.UseSqlServer(@"Server=DESKTOP-OSRLGA7\SQLEXPRESS;Database=AdamTaskingApp;Trusted_Connection=True;MultipleActiveResultSets=true;"));
